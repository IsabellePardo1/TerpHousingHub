...
search_button = ttk.Button(search_field, text='Search', command = search_listing, width = 8)
...
add_button = ttk.Button(command_frame, text = "Add New Housing Unit", command=new_listing)
